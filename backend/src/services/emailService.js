...
const sendOrderConfirmationEmail = async (order) => {
  ...
  // Build the item rows from the real order items instead of a single
  // hardcoded (and previously undefined) `item` reference.
            ...
            <tr>
              <td style="width:72px;vertical-align:top;" class="mobile-hide">
                <div style="width:72px;height:72px;background:#ffffff;border-radius:10px;border:1px solid #e5e7eb;overflow:hidden;">
                  <img src="${item.image || 'https://via.placeholder.com/72x72/fdf2f8/db2777?text=MM'}" alt="${item.name || 'Product'}" width="72" height="72" style="display:block;width:72px;height:72px;object-fit:cover;">
                </div>
              </td>
              ...
              <td style="vertical-align:top;">
                ...
                <p style="margin:0;color:#db2777;font-size:14px;font-weight:700;">KES ${Number(item.price || 0).toLocaleString()}</p>
              </td>
            </tr>
          </table>
        </td>
...
<head>
  ...
  <title>Your ${BRAND_NAME} Order Confirmation</title>
  <!--[if mso]>
  <noscript>
    <xml>
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:600px;background-color:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 10px 40px rgba(0,0,0,0.08);">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td style="text-align:center;">
                    ...
                    <h1 style="color:#ffffff;margin:0;font-size:26px;font-weight:800;letter-spacing:-0.5px;">${BRAND_NAME}</h1>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td style="text-align:center;">
                    ...
                    <p style="color:#6b7280;margin:0;font-size:15px;line-height:1.6;">Hi <strong style="color:#111827;">${name}</strong>, thank you for choosing ${BRAND_NAME}. We've received your order and our team is carefully packing your items.</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding:0 32px 32px;text-align:center;" class="mobile-padding">
              ...
              <p style="margin:12px 0 0;color:#9ca3af;font-size:12px;">Or copy: <span style="color:#6b7280;font-family:monospace;">${STORE_URL}/orders/${orderNo}</span></p>
            </td>
          </tr>

          <tr>
            <td style="padding:0 32px 24px;" class="mobile-padding">
              <h3 style="color:#111827;margin:0 0 16px;font-size:16px;font-weight:700;">Order Items (${items.length})</h3>
              ${itemsHtml || '<p style="color:#9ca3af;font-size:13px;">Item details unavailable</p>'}
            </td>
          </tr>
        ...
        <body style="margin:0;padding:0;background:#f8fafc;font-family:Inter,Arial,sans-serif;">
          <div style="max-width:600px;margin:0 auto;padding:24px;">
            <div style="background:#111827;border-radius:16px;padding:24px;">
              ...
              <a href="https://${STORE_URL}/orders" style="display:block;background:linear-gradient(135deg,#db2777,#be185d);color:white;text-align:center;padding:12px;border-radius:8px;margin-top:16px;text-decoration:none;font-size:13px;font-weight:600;">View in Admin Dashboard</a>
            </div>
          </div>
        </body>
        </html>
        ...
        <body style="margin:0;padding:0;background:#f8fafc;font-family:Inter,Arial,sans-serif;">
          <div style="max-width:600px;margin:0 auto;padding:24px;">
            <div style="background:linear-gradient(135deg,#db2777,#be185d);border-radius:16px 16px 0 0;padding:32px;text-align:center;">
              <h1 style="color:white;margin:0;font-size:22px;font-weight:800;">${BRAND_NAME}</h1>
            </div>
            ...
            <div style="text-align:center;padding:16px;">
              <p style="color:#9ca3af;font-size:11px;margin:0;">&copy; 2026 ${BRAND_NAME}. Nairobi, Kenya.</p>
            </div>
          </div>
        </body>
        </html>
