    ...
    onSuccess: async (order) => {
      if (paymentMethod === "mpesa") {
        ...
        try {
          ...
          window.open(pesapalRes.redirectUrl, "_blank")
  ...
  if (completed) {
    return (
      <div className="min-h-screen bg-dashboard text-white">
        ...
        <main
          className={cn(
            "pt-20 pb-8 px-6 transition-all duration-300 flex items-center justify-center",
        ...
        >
          <GlassCard className="max-w-md w-full text-center">
            ...
            <div className="bg-white/5 rounded-xl p-4 mb-6 text-left space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-accent-green">
                  KES {Number(completed.grandTotal).toLocaleString()}
                </span>
              </div>
              <div className="flex justify-between">
            ...
            <button
              ...
              className="w-full bg-accent-green hover:bg-green-600 text-white rounded-xl py-3 font-medium transition-colors"
            >
              New Sale
            </button>
          </GlassCard>
            ...
            <GlassCard>
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-accent-green/50"
                />
              </div>

              {productsLoading ? (
                <div className="flex items-center justify-center py-12">
                  <div className="w-8 h-8 border-2 border-white/20 border-t-accent-green rounded-full animate-spin" />
                </div>
              ) : (
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3 max-h-[calc(100vh-280px)] overflow-y-auto">
                  {filtered?.length === 0 ? (
                    <p className="text-gray-400 text-sm text-center py-8 col-span-full">
                      No products found
                    </p>
                  ) : (
                    filtered?.map((product: any) => (
                      <button
                        ...
                        className="p-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-left transition group disabled:opacity-40 disabled:cursor-not-allowed"
                      >
            ...
            <GlassCard>
              ...
              <div className="space-y-2 mb-4">
                <input
                  ...
                  className="w-full bg-white/10 border border-white/20 rounded-lg px-3 py-2 text-xs text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-accent-green/50"
                />
                <input
                  value={customerPhone}
                  ...
                  placeholder={
                    paymentMethod === "mpesa"
                      ? "Customer phone (required for M-Pesa)"
                      : "Customer phone (optional)"
                  }
                  className={`w-full border rounded-lg px-3 py-2 text-xs text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-accent-green/50 ${
                    paymentMethod === "mpesa"
              ...
              <div className="border-t border-white/10 pt-4 space-y-3">
                ...
                <button
                  ...
                  className="w-full bg-accent-green hover:bg-green-600 disabled:opacity-40 text-white font-bold py-3 rounded-lg transition mt-4"
                >
                ...
                <button
                  onClick={clearCart}
                  className="w-full bg-white/10 hover:bg-white/20 text-white font-medium py-2 rounded-lg transition"
                >
                  Clear Cart
                </button>
              </div>
